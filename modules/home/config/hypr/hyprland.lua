...
hl.bind(mainMod .. " + SHIFT + M", function() local w = hl.get_active_workspace(); if not w then return end; hl.dispatch(hl.dsp.workspace.move({ workspace = w.id, monitor = "DP-7" })) end)
...
local screenshotarea = "hyprctl eval 'hl.animation({ leaf = \"fadeOut\", enabled = false })'; grimblast --notify copysave area " .. saveto .. "; hyprctl eval 'hl.animation({ leaf = \"fadeOut\", enabled = true, speed = 4, bezier = \"default\" })'"
